    ...
    <header className={`${!showHeader && "hidden"} w-full bg-[#026db5] fixed top-0 z-50`}>
      ...
      >
        ...
        <div className="flex items-center gap-x-4 ml-8">
          <div className="lg:flex flex-col items-center px-3 gap-y-1 hidden group">
            ...
            <div
              ...
              className="absolute bg-white rounded-md shadow-md p-2 mt-4 z-50 hidden group-hover:block"
            >
              {currentUser ? (
                <div className="block">
                  <div className="p-2">
